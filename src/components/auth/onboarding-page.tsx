...
const questions = [
  {
    ...
    helper: 'We use this to personalize your first experience.',
    options: [
      'Founder / CEO - Building the product, doing sales myself',
      'Marketing / Content - Head of Marketing, PMM, Content Manager',
      'Agency / Consultant - Producing content for multiple B2B clients - Agency plan',
      'Customer Success / Sales - Using customer stories to close deals',
    ],
  },
  {
    id: 'customers',
    label: 'How many customers do you have right now?',
    helper: "This tells us how many story opportunities you're sitting on.",
    options: [
      '1 - 20 customers - Early stage, every story matters',
      '20 - 100 customers - Growing, you have untapped story inventory',
      '100 - 500 customers - Scaling, most of your stories are unpublished',
      '500+ customers - At scale, production is your bottleneck',
    ],
  },
  {
    id: 'case_studies',
    label: 'How are you handling case studies today?',
    helper: 'Be honest - most teams are in one of these situations.',
    options: [
      'We have none (or almost none) - Sales keeps asking, we keep deprioritizing',
      'Manual process - takes weeks - Interviews, writing, review cycles, design',
      'Using AI tools but output feels generic - Jasper, ChatGPT, no real data behind it',
      'We use an agency or freelance writer - Expensive and still slow - $500-2,500 per story',
    ],
  },
  {
    id: 'revenue_tool',
    label: 'Which tool do you use for revenue data?',
    helper: 'ProveKit reads directly from your data source - no manual entry.',
    options: [
      'Stripe - Direct MRR, churn, upgrade data - 2 min setup',
      'Stripe + Analytics (PostHog / Amplitude) - Revenue + usage data - Recommended',
      'HubSpot / Salesforce - CRM deal data + customer success notes',
      "We don't use Stripe yet - We'll use manual metrics for now",
    ],
  },
] as const;
    ...
    <div className="relative hidden h-full min-h-[760px] overflow-hidden rounded-l-[32px] rounded-r-[32px] bg-[linear-gradient(180deg,#db6718_0%,#ea7824_42%,#f48a46_74%,#ffc7a1_100%)] px-10 py-10 lg:flex lg:flex-col">
      ...
      <div className="relative z-10 mt-[18%] max-w-[440px] pl-6 xl:pl-8">
        ...
        <p className="max-w-[13ch] text-[30px] font-semibold leading-[1.12] tracking-[-0.025em] text-white xl:text-[34px]">
          One clear answer at a time makes your first setup much easier.
        </p>

        <div className="mt-8">
          <div className="text-[16px] font-semibold text-white">ProveKit Onboarding</div>
          <div className="mt-1 text-[15px] text-white/78">
        ...
        <section className="relative z-10 flex min-h-full flex-col overflow-hidden rounded-l-[32px] rounded-r-[32px] bg-[linear-gradient(180deg,#ffffff_0%,#fffdf9_100%)] px-8 py-8 shadow-[0_14px_40px_rgba(15,23,42,0.04)] lg:px-14 lg:py-10">
          ...
          <div className="mx-auto flex w-full max-w-[560px] flex-1 flex-col justify-center rounded-[36px] py-10">
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-[16px] text-[#667085]">{question.helper}</p>
            </div>
