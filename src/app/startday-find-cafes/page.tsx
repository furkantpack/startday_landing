...
const cities = [
  {
    ...
    image: '/bold-moves-tallinn-cafe-card.png',
    href: '/cafe/tallinn',
  ...
  },
  {
    ...
    image: '/bold-moves-helsinki-cafe-card.png',
    href: '/cafe/helsinki',
  ...
  },
  {
    ...
    image: '/bold-moves-stockholm-cafe-card.png',
    href: '/cafe/stockholm',
  ...
  },
  {
    ...
    image: '/bold-moves-copenhagen-cafe-card.png',
  ...
  },
  {
    ...
    image: '/bold-moves-berlin-cafe-card.png',
    href: '/cafe/berlin',
  ...
  },
  {
    ...
    earliestDate: '10-12 July',
    capacity: '4 tables left',
    image: '/bold-moves-istanbul-cafe-card.png',
    href: '/cafe/istanbul',
  ...
  },
  {
    ...
    earliestDate: '10-12 July',
    capacity: '3 tables left',
    image: '/bold-moves-paris-cafe-card.png',
    href: '/cafe/paris',
  ...
  },
  {
    ...
    earliestDate: '10-12 July',
    capacity: '2 tables left',
    image: '/bold-moves-vienna-cafe-card.png',
    href: '/cafe/vienna',
        ...
        <main className="min-w-0 flex-1">
          <section className="bg-[#fffbe8] py-8 lg:py-12">
            <div className="mb-10 text-center">
              ...
              <h1 className="mx-auto max-w-[680px] text-[2rem] font-black leading-[1.02] tracking-[-0.065em] text-[#1d1d19] sm:text-[2.55rem]">
                Pick the city where your brand should enter the room.
              </h1>
              <p className="mx-auto mt-4 max-w-[560px] text-[1.05rem] font-semibold leading-[1.32] tracking-[-0.035em] text-[#6f6251]">
            ...
            <div className="mb-8 grid gap-3 rounded-[7px] border border-dashed border-[#b9ae84] bg-[#fffdf1] p-4 sm:grid-cols-2 lg:mx-auto lg:max-w-[760px]">
              <label className="block">
                ...
                <select
                  ...
                  className="h-[52px] w-full rounded-[7px] border border-[#1d1d19]/15 bg-[#fffbe8] px-3 text-[1rem] font-black tracking-[-0.035em] text-[#1d1d19] outline-none"
                >
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              {filteredCities.map((item) => (
                ...
                >
                  ...
                  <h2 className="mt-2 text-[2rem] font-black leading-none tracking-[-0.055em] text-[#1d1d19]">
                    {item.city}
                  </h2>

                  <div className="mt-auto grid gap-2 pt-10 text-[1rem] font-medium tracking-[-0.035em] text-[#1d1d19]">
                  ...
                  <Link
                    href={item.href}
                    className="mt-5 flex h-[54px] w-full items-center justify-center gap-2 rounded-[7px] border border-[#1d1d19] bg-[#ffe779] text-[1.05rem] font-black tracking-[-0.035em] text-[#1d1d19] shadow-[0_12px_24px_rgba(29,29,25,0.10)] transition-transform duration-300 hover:-translate-y-1"
                  >
